...
public class logrosScreen extends AbstractScreen {
	...
	private void mostrarLogrosESP(){
		...
		texto.drawMultiLine(batch, "Recién llegado (Muere 10 veces): " + game.muertes + "/10", 140, 430);
		...
		texto.draw(batch, "Mejorando día a día (Coge 60 bichos de un intento): " + game.maxPantalla + "/60", 140, 390);
		...
		texto.draw(batch, "Piensa en los demás (Envia 40 bichos al nido): " + game.puntosNido + "/40", 140, 310);
		...
		texto.draw(batch, "Robin Gorriónhood (envia 100 bichos al nido): " + game.puntosNido + "/100", 140, 270);
		...
		texto.draw(batch, "Maestro gorrión (Consigue todos los logros): 0/11", 140, 230);
